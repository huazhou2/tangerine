...
echo "[1/8] Submitting Job 1: Pretrained layers 0-8 + pre/post norm..."
...
echo "[2/8] Submitting Job 2: Pretrained layers 9-16 + attention heads..."
...
echo "[3/8] Submitting Job 3: Pretrained layers 17-23 + pooling..."
...
echo "[4/8] Submitting Job 4: Trained final layer..."
...
echo "[5/8] Submitting Job 5: Coherence analysis (pretrained) [depends on 1-3]..."
...
python lrads_coherence_analysis.py \
    --embeddings_dir outputs/pretrained/embeddings/pretrain \
    --model_type pretrain \
    --output_dir outputs/pretrained/embeddings/analysis
JOBEOF
)
echo "  Job ID: $JOB5"

# JOB 6: Coherence analysis trained
echo "[6/8] Submitting Job 6: Coherence analysis (trained) [depends on 4]..."
...
echo ""
echo "================================================================================"
echo "✅ 6 EXTRACTION & ANALYSIS JOBS SUBMITTED"
echo "================================================================================"
echo ""
...
echo "  Pretrained: outputs/pretrained/embeddings/{pretrain,analysis}/"
echo "  Trained:    outputs/run_20260529_101746/embeddings/{trained,analysis}/"
echo ""
